...
def select_box(screen, pos, pos_angle):
    selected_box = pos
    pygame.draw.circle(screen, BLUE, selected_box, 10)
    length = 50
    end_x = selected_box[0] + length * math.cos(math.radians(pos_angle))
    end_y = selected_box[1] - length * math.sin(math.radians(pos_angle))
